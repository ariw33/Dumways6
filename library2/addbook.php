...
function preview() {
    ...
    oFReader.onload = function(oFREvent) {
      document.getElementById("cover-img").src = oFREvent.target.result;
    };
  };
</script>
...
<li class=" bd-menuitem-36
 ...
 data-page-id="page.11">
    <section class=" bd-section-5 bd-page-width bd-tagstyles " id="section4" data-section-title="Hosting Three Columns">
    <div class="bd-container-inner bd-margins clearfix">
 ...
 col-md-6">
    ...
    <form action="tmb.php" method="post" enctype="multipart/form-data">
    <table style="width:100%">
    <tr style="width:100%">
    <td align="center" style="width:50%">
    <label for="cover">Cover buku</label><br> 
    <img id="cover-img" src="./assets/images/defaultImage.png"/><br>
    <input type="file" id="cover" name="cover" onChange="preview();">
    </td>      
    <td style="width:50%">
	...
	<?php
	//print all category
	$cekcat = mysqli_query($koneksi,"SELECT * FROM category_tb");
	while($cekcat1 = mysqli_fetch_assoc($cekcat)){
		echo '<option value="'.$cekcat1['name'].'">'.$cekcat1['name'].'</option>';
		}	
	?>
    </select><br>
	...
	<?php
	//Print all name writer
	$cekwrite = mysqli_query($koneksi,"SELECT * FROM writer_tb");
	while($cekwrite1 = mysqli_fetch_assoc($cekwrite)){
		echo '<option value="'.$cekwrite1['name'].'">'.$cekwrite1['name'].'</option>';
		}	
	?>
    </select><br>
    <label for="publikasi">Tahun publikasi</label>
    <input name="publikasi" id="publikasi" type="number" min="1980" max="<?php echo date("Y"); ?>" required><br>
 ...
 col-lg-4
 col-md-12" style="background-image:url(assets/images/c441f30802757ce5e158439335c93909_bossfightfreehighqualitystockimagesphotosphotographycoloredpencils960x640.jpg); background-size:100% 100%;">
    <div class="bd-layoutcolumn-21 bd-textureoverlay bd-textureoverlay-2 bd-column" ><div class="bd-vertical-align-wrapper"><h1 class=" bd-textblock-44 bd-content-element">
    Tambahkan Buku
</h1>
    ...
    A wonderful opportunity for all students to explore and develop skills in drawing and life drawing.&nbsp;Each student will finish the weekend with a series of drawings.
</p>
