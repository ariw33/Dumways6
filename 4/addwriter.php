...
<li class=" bd-menuitem-36
 ...
 col-md-6">
    ...
    <form action="tmb2.php" method="post">
    ...
    <input type="text" id="nama" name="nama" placeholder="Nama penulis" required><br>
    <label for="kelamin">Gender</label>&nbsp;&nbsp;
    <input type="radio" id="kelamin" name="kelamin" value="Pria" required>&nbsp;Pria &nbsp;&nbsp;<input type="radio" id="kelamin" name="kelamin" value="Wanita">&nbsp;Wanita<br>
    <br>
    <label for="keterangan">Keterngan penulis</label>
    <textarea name="keterangan" rows="5" cols="50" placeholder="keterangan"></textarea><br>
